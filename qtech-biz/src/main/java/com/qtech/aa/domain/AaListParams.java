...
public class AaListParams extends BaseEntity {
    ...
    @Excel(name = "aa3FC", cellType = Excel.ColumnType.STRING, prompt = "item")
    private String aa3FC;
    @Excel(name = "aa3F1", cellType = Excel.ColumnType.STRING, prompt = "item")
    private String aa3F1;
    @Excel(name = "aa3F2", cellType = Excel.ColumnType.STRING, prompt = "item")
    private String aa3F2;
    @Excel(name = "aa3F3", cellType = Excel.ColumnType.STRING, prompt = "item")
    private String aa3F3;
    @Excel(name = "aa3F4", cellType = Excel.ColumnType.STRING, prompt = "item")
