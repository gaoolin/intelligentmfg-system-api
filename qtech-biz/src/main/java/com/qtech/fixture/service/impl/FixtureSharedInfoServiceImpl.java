...
import com.qtech.fixture.mapper.FixtureSharedInfoMapper;
import com.qtech.fixture.service.*;
import com.qtech.common.annotation.DataScope;
import com.qtech.common.exception.biz.AddFixtureSharedInfoException;
import com.qtech.common.exception.biz.DeleteFixtureSharedInfoException;
import com.qtech.common.exception.biz.EditFixtureSharedInfoException;
import com.qtech.common.exception.biz.FixtureUploadException;
...
public class FixtureSharedInfoServiceImpl implements IFixtureSharedInfoService {
    ...
    public int addFixtureSharedInfo(FixtureSharedInfo fixtureSharedInfo) {
        ...
        if (StringUtils.isEmpty(fixtureSharedInfo.getMaterialId())) {
        ...
        fixtureMaterialInfoTmp.setMaterialId(fixtureMaterialInfo.getMaterialId());
        ...
        try {
            ...
            l = 0;
            log.error("治具信息重复： " + fixtureMaterialInfo.getMaterialId() + "-" + fixtureProdTypeInfo.getProdType() +
    ...
    public int deleteFixtureSharedInfo(FixtureSharedInfo fixtureSharedInfo) {
        ...
        if (empty) {
            ...
            if (fixtureMaterialCategoryProdType.getmId() == null) {
                if (fixtureSharedInfo.getMaterialId() != null) {
            ...
            // 料号是否可以删除（可删）
            Boolean materialIdDeleteOk = fixtureUtils.fixtureMaterialIdMultipleReferenceCheck(fixtureSharedInfo.getMaterialId(), fixtureSharedInfo.getDeptId());
